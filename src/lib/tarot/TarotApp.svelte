...
<div class="container">
  ...
  <TarotTable {spread} {seed} bind:reversedChance />
</div>
...
<style>
  ...
  .button{ background:linear-gradient(180deg, #1a2233, #101827); color:#e9eef8; border:1px solid #2d3b57; padding:10px 14px; border-radius:12px; }
</style>